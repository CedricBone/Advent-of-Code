...
for food in input:
    if food == "\n":
        if current_calories > most_calories:
            ...
            most_elf_number = elf_number
        print(f"Elf number {elf_number} has {current_calories} calories.")
        current_calories = 0
        elf_number += 1
    else:
...
print(f"Elf number {elf_number} has {current_calories} calories.")
print(
    f"\nElf number {most_elf_number} has the most calories with {most_calories} calories in total.\n")
